;(function () {
  ...
  function getStoredTheme() {
    try {
      ...
      console.warn(
        '[dark-mode-toggle] Error reading theme from localStorage:',
        error
      )
      return null
    }
  ...
  function setStoredTheme(theme) {
    try {
      ...
      console.warn(
        '[dark-mode-toggle] Error saving theme to localStorage:',
        error
      )
    }
  }
  ...
  function toggleTheme() {
    const currentTheme = document.documentElement.classList.contains(DARK_CLASS)
      ? 'dark'
      : 'light'
