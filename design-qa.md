...
- Scrolling: desktop steps use the page rather than a nested right-panel scroller. The journey artwork and results move together on the single document scrollbar, and no horizontal scrollbar appears.
